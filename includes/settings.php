		...
		<table class="form-table">
			<tbody>
				<tr>
					...
					<td>
    					<input type="text" name="settings[sppb_previous]" id="sppb_previous" value="<?php echo esc_attr($this->sppb_previous); ?>" /><br />
				...
				<tr>
					...
					<td>
						<input type="text" name="settings[sppb_next]" id="sppb_next" value="<?php echo esc_attr($this->sppb_next); ?>" /><br />
				...
				<tr>
					...
					<td>
						<input type="text" name="settings[sppb_size]" id="sppb_size" size="3" value="<?php echo esc_attr($this->sppb_size); ?>" /><br />
					...
					<td>
						<select name="settings[sppb_image_setting]" id="sppb_image_setting">
							...
							<?php foreach ( $imagesettings as $imagesetting ): ?>
	   							<option value="<?php echo esc_attr($imagesetting); ?>" <?php echo ( $imagesetting == $this->sppb_image_setting ) ? 'selected' : ''; ?> /><?php echo $imagesetting; ?></option>
	   						<?php endforeach; ?>
						</select><br />
				...
				<tr>
					...
					<td>
						<input type="text" name="settings[sppb_exclude_category]" value="<?php echo esc_attr($this->sppb_exclude_category); ?>" /><br />
				...
				<tr>
					...
					<td>
						<input type="text" name="settings[sppb_exclude_product]" value="<?php echo esc_attr($this->sppb_exclude_product); ?>" /><br />
				...
				<tr>
					...
					<td>
						<input type="text" name="settings[sppb_products_limit]" id="sppb_products_limit" size="3" value="<?php echo esc_attr($this->sppb_products_limit); ?>" /><br />
